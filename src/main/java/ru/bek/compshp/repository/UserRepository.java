...
public interface UserRepository extends JpaRepository<User, Long> {
     ...
     * @param token код активации
     * @return Optional с пользователем
     */
    Optional<User> findByActivationCode(String token);
    ...
    /**
     * Находит пользователей, чей токен сброса пароля истек
     * @param date дата истечения токена
     * @return список пользователей
     */
    List<User> findByResetTokenExpiryBefore(LocalDateTime date);
